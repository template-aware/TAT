...
from .backbones.vit_pytorch import (
    ...
    vit_base_patch16_224_TAT,
    vit_small_patch16_224_TAT,
    deit_small_patch16_224_TAT,
)
...
class build_transformer_local(nn.Module):
    ...
    def forward(
        self, x, label=None, cam_label=None, view_label=None, get_attn_weights=False
    ):  # label is unused if self.cos_layer == 'no'

        if get_attn_weights:
            features, attn_weights = self.base(
                x,
                cam_label=cam_label,
        ...
        if get_attn_weights:
            return final_feat, attn_weights
        else:
            return final_feat
...
__factory_T_type = {
    ...
    "vit_base_patch16_224_TAT": vit_base_patch16_224_TAT,
    "deit_base_patch16_224_TAT": vit_base_patch16_224_TAT,
    "vit_small_patch16_224_TAT": vit_small_patch16_224_TAT,
    "deit_small_patch16_224_TAT": deit_small_patch16_224_TAT,
}
