...
class MSMT17(BaseImageDataset):
    ...
    def __init__(self, root="", verbose=True, pid_begin=0, **kwargs):
        ...
        # self.train_dir = osp.join(self.dataset_dir, 'train')  # v1
        # self.test_dir = osp.join(self.dataset_dir, 'test')  # v1
        self.train_dir = osp.join(self.dataset_dir, "mask_train_v2")  # v2
        self.test_dir = osp.join(self.dataset_dir, "mask_test_v2")  # v2
